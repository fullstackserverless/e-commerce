...
export const getHeaderProp = (name: string): headerProp => {
    ...
    switch (true) {
        ...
        case name === 'TAB_SHOP':
            return {
                title: 'Shop', visible: true,
                size: 'small'
            }
        case name === 'TAB_BAG':
            return {
                title: 'Bag', visible: true,
                size: 'big'
            }
        case name === 'TAB_FAVORITES':
            return {
                title: 'Favorites', visible: true,
                size: 'big'
            }
        ...
        case name === 'EXAMPLES':
            return {
                title: 'Examples', visible: true,
                size: 'big'
            }
        // Put the props for the start screen
        default: return initialScreenProp
    }
}